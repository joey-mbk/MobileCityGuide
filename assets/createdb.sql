...
CREATE TRIGGER on_deleteUserName AFTER DELETE ON User BEGIN DELETE FROM UserCategory WHERE userName = old.userName; DELETE FROM UserItinerary WHERE userName = old.userName; DELETE FROM Language WHERE userName = old.userName; END;
