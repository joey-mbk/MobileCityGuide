...
CREATE TRIGGER on_deleteItineraryID AFTER DELETE ON ItineraryTitles BEGIN DELETE FROM UserItinerary WHERE itineraryID = old.itineraryID; DELETE FROM POIItinerary WHERE itineraryID = old.itineraryID; END;
CREATE TRIGGER on_deleteCategoryID AFTER DELETE ON CategoryTitles BEGIN DELETE FROM UserCategory WHERE categoryID = old.categoryID; DELETE FROM POICategory WHERE categoryID = old.categoryID; END;
