...
public class GPSController {
	...
	public static String getUrl(Location userLocation, Location poi) {
		...
		urlString.append(Double.toString(userLocation.getLatitude()));
		urlString.append(",");
		urlString.append(Double.toString(userLocation.getLongitude()));
		urlString.append("&daddr="); // end point
		urlString.append(Double.toString(poi.getLatitude()));
		urlString.append(",");
		urlString.append(Double.toString(poi.getLongitude()));
		urlString.append("&ie=UTF8&0&om=0&output=kml&mode=walking");
